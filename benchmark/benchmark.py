...
for name, fields in benchmarks.items():
    ...
    if fields['answer'] == answers:
        print('{} Correct. Answer: {}, took {}s'.format(name, fields['answer'], end - start))
    else:
        print('{} Incorrect. Got: {}, expected {}, took {}s'.format(name, answers, fields['answer'], end - start))
